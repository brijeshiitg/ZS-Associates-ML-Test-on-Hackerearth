...
# clf = MLPClassifier(solver='lbfgs', alpha=1e-5, hidden_layer_sizes = (100,50),random_state=1, verbose=True, max_iter=1000)
clf = MLPClassifier(hidden_layer_sizes=(200,100,50,20), activation='relu',
					solver='adam', learning_rate='adaptive',
					learning_rate_init=0.001, random_state=1, verbose=True, n_iter_no_change=10)
# clf = MLPClassifier(hidden_layer_sizes=(200,100,50,20), activation='tanh',
#                     solver='adam', learning_rate='adaptive',
#                     learning_rate_init=0.001, random_state=1, verbose=True, n_iter_no_change=10)
...
print('submissionMLP.csv file is created')
